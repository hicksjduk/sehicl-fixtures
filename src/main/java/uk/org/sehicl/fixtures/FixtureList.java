...
{
    private final static List<FixtureList> INSTANCES = Arrays.asList(new FixtureList("D1", 6, 2),
            new FixtureList("D2", 6, 2), new FixtureList("D3", 10, 1), new FixtureList("D4", 10, 1),
            new FixtureList("D5", 10, 1));
    ...
    public static List<FixtureList> getInstances()
    {
        return INSTANCES;
    }
